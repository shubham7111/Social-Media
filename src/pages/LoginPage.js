...
const LoginPage = () => {
    ...
    const loginDetailSetter = (e) => {
      setUserLoginInfo((userLoginInfo) => ({...userLoginInfo, [e.target.name]: e.target.value}))
  ...
  return (
    ...
    <h2>Login</h2>
    <form className='login-form' onSubmit={preventData}>
    <div className='form-group'>
      <label  for="username">Username:</label>
      <input type = "text" placeholder="username" name='username' onChange={loginDetailSetter}/>
    </div>
    <div className='form-group'>
      <label  for="password">Password:</label>
      <input type = "password" placeholder="password" name='password' onChange={loginDetailSetter}/>
    </div>
    <div className='form-group'>
      <button type="submit" onClick={loginButtonHandler}>Login </button>
      <button  type="submit" onClick={loginGuestHandler}>Login As Guest</button>
      <button type="submit" onClick={logoutGuestHandler}>Logout </button>
      
    </div>
    <div className='form-group'>
    <NavLink to = "/signup" className="link"> Create a New Account ? Signup </NavLink>
    </div>
